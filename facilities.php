...
#myInput{
  ...
  <title>MatchMaker | Tesisler</title>
</head>
...
?>
  ...
  <div style="margin-top: 30px;" class="container">
    ...
    <div style="margin-top: 20px; margin-bottom: 40px;" class="row">
      <div class="col">
      <input class="btn-primary" id="myInput" class="form-control" type="text" placeholder="TESİS ARAMA">
      </div>
    ...
    <div class="row">
      <div class="col">
       ...
       <tr>
            ...
            <td class="foot"  >
            <a href="FacilitySpecial.php?id=<?= $tesis->ID ?>"><?= $tesis->tesisadi ?></a>

            </td>
            <td class="playerphoto" >
              <a href="FacilitySpecial.php?id=<?= $tesis->ID ?>"><img style="width:100px;height:60px" src="<?= $tesis->resim ?>"> 
           ...
           <?= $tesis->sahatipi ?>
            ...
            <td class="age" >
             <a href="FacilitySpecial.php?id=<?= $tesis->ID ?>">Görüntüle </a>
