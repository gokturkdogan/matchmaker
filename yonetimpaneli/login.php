    ...
    <div class="card-body login-card-body">
      ...
      if($_POST){
          if(!empty($_POST["kullanici"]) && (!empty($_POST["sifre"]))){
              ...
              $kontrol=$VT->getdata("kullanicilar","WHERE kullanici=? AND sifre=?",array($kullanici,$sifre),"ORDER BY ID ASC",1);
              if($kontrol!=false){
              ...
              echo '<div class="alert alert-danger">Boş Bıraktığınız Yerleri Doldurunuz.</div>';
          }
      ...
      <form action="#" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <input type="submit" name="submit" value="Giriş" class="btn btn-primary btn-block">
          </div>
          <!-- /.col -->
        </div>
      </form>
