...
if(isset($_POST["guncelle"])) {
  $id= $_POST["id"];
  $update=$vt-> prepare("UPDATE maclar set takimbkaleci = :takimbkaleci, takimbdefans1 = :takimbdefans1,
  takimbdefans2 = :takimbdefans2, takimbdefans3 = :takimbdefans3, takimbortasaha1 = :takimbortasaha1, takimbortasaha2 = :takimbortasaha2, takimbforvet = :takimbforvet where id = :id");
  $maclar = $update -> execute(array(
'takimbkaleci' => $_POST["takimbkaleci"],
'takimbdefans1' => $_POST["takimbdefans1"],
'takimbdefans2' => $_POST["takimbdefans2"],
'takimbdefans3' => $_POST["takimbdefans3"],
'takimbortasaha1' => $_POST["takimbortasaha1"],
'takimbortasaha2' => $_POST["takimbortasaha2"],
'takimbforvet' => $_POST["takimbforvet"],
'id' =>$_GET["id"]
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Takım B</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
    ...
    <!-- /.content -->
               ...
               <input type="hidden" name="id" value="<?php echo $maclar["id"] ?>">
                 <div style="text-align:center" class="row">
                   <div class="col">
               <label><img src="../../../matchmaker/assest/images/takimbkaleciicon.png"></label> <br>
                <select style="width:50px" name="takimbkaleci">
                <option></option>
                ...
                <div style="text-align:center;padding-top:30px" class="row">
                   <div class="col">
               <label><img src="../../../matchmaker/assest/images/takimbicon.png"></label> <br>
                <select style="width:50px" name="takimbdefans1">
                <option></option>
                ...
                <div class="col">
               <label><img src="../../../matchmaker/assest/images/takimbicon.png"></label> <br>
                <select style="width:50px" name="takimbdefans2">
                <option></option>
                <?php foreach($defanslar as $defans){?>
                <option><?= $defans->isim ?></option>
                <?php } ?>
                ...
                <div class="col">
               <label><img src="../../../matchmaker/assest/images/takimbicon.png"></label> <br>
                <select style="width:50px" name="takimbdefans3">
                <option></option>
                <?php foreach($defanslar as $defans){?>
                <option><?= $defans->isim ?></option>
                <?php } ?>
                ...
                <div style="text-align:center;padding-top:30px" class="row">
                   <div class="col">
               <label><img src="../../../matchmaker/assest/images/takimbicon.png"></label> <br>
                <select style="width:50px" name="takimbortasaha1">
                <option></option>
                ...
                <div class="col">
               <label><img src="../../../matchmaker/assest/images/takimbicon.png"></label> <br>
                <select style="width:50px" name="takimbortasaha2">
                <option></option>
                <?php foreach($ortasahalar as $ortasaha){?>
                <option><?= $ortasaha->isim ?></option>
                <?php } ?>
                ...
                <div class="col">
               <label><img src="../../../matchmaker/assest/images/takimbicon.png"></label> <br>
                <select style="width:50px" name="takimbforvet">
                <option></option>
